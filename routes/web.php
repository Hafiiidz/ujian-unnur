...
//admin
    //User
    Route::get('/admin/user','AdminController@index_user');
    Route::post('/admin/user/simpan','AdminController@simpan_user')->name('simpan.user');
    Route::get('/admin/user/hapus/{id}','AdminController@hapus_user')->name('hapus.user');
    Route::get('/admin/user/get_user','AdminController@get_user')->name('get.user');
    Route::post('/admin/user/ubah','AdminController@ubah_user')->name('ubah.user');
    //pengaturan
...
//dosen
    ...
    Route::get('/dosen/laporan/list-mhs/cetak_daftar_nilai/{id}','LaporanController@cetak_nilai')->name('cetak.daftar_nilai');
    Route::get('/dosen/laporan/list-mhs/detail-mhs/{path}','LaporanController@get_file')->name('show.file');
     //update nilai
