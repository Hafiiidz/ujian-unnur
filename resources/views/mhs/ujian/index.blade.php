          ...
          <div class="x_panel">
            ...
            <div class="x_content">
                <div class="row">
                    ...
                    <?php
                      $cek_soal_pg = DB::table('tbl_jawab_pg')->where('id_paket_soal', $item->id_paket_soal)->where('id_mhs', $id_mhs)->first();
                      $cek_soal_essay = DB::table('tbl_jawab_essay')->where('id_paket_soal', $item->id_paket_soal)->where('id_mhs', $id_mhs)->first();
                    ?>
