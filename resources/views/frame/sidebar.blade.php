<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
    <div class="menu_section">
        ...
        <ul class="nav side-menu">
            ...
            @endcan
            @can('manage-prodi')
            <li class="@yield('title_1_user')"><a href="{{ url('/prodi/filter-soal') }}"><i class="fa fa-tasks"></i>Filter Soal</a>
            @endcan
            @can('manage-mhs')
                <li class="@yield('title_1')"><a href="{{ url('/mhs/ujian') }}"><i class="fa fa-tasks"></i>Ujian</a>
            @endcan
            @can('manage-admin')
                <li class="@yield('title_1')"><a href="{{ url('/admin/user') }}"><i class="fa fa-users"></i>User</a></li>
                ...
                <li class="@yield('title_1')"><a href="{{ url('/admin/pengaturan') }}"><i class="fa fa-cogs"></i>Pengaturan</a></li>
            @endcan
        </ul>
    </div>
</div>
