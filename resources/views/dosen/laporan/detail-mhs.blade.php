              ...
              <table class="table">
                  <tbody>
                      ...
                      <tr>
                        ...
                        <td>:</td>
                        <td>
                            <input type="number" class="form-control" id="nilai_essay" name="nilai_essay" value="{{ $data_nilai->nilai_essay }}" required>
            ...
            <div class="card-box table-responsive">
              ...
              <table id="datatable-1" class="table table-striped table-bordered" style="width:100%">
                  ...
                  <tr>
                      ...
                      <td>
                        @if(empty($item->jawab_file))
                          Kosong
                        @else
                        <a href="{{ route('show.file',$item->jawab_file) }}" target="_blank">
                          {{ $item->jawab_file }}
                        </a>
                        @endif
                      </td>
...
<script>
  function tampilData (id) {
      ...
      data:{'id_soal_essay':get_id,'id_mhs':mhs},
      success:function(data){
                  $("#soal_essay").val(data.soal_essay);
                  $("#jawaban_essay").val(data.jawaban_essay);
                  //$("#link").text(data.jawab_file);
                  //document.getElementById("myImg").src = data.jawab_file;
      }
    });
  }
</script>
