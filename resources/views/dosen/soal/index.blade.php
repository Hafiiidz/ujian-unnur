        ...
        <div class="modal-body">
            ...
            @csrf
                <div class="form-group">
                    <select name="kategori_soal" id="kategori_soal" class="js-example-basic-responsive" style="width: 50%" required></select>
                </div>
                <div class="form-group">
                    <label for="">Nama Paket Soal</label>
                    <input type="text" name="nama_paket_soal" id="nama_paket_soal" class="form-control" placeholder="ex: Bahasa Inggris" required>
                </div>
                {{-- <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="waktu" id="waktu" class="form-control" placeholder="ex: 60 *Satuan Menit" required>
                </div>
        </div>
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    <label for="">Nama Paket Soal</label>
                    <input type="text" name="nama_paket_soal" id="nama_paket_soal_ubah" class="form-control" placeholder="ex: Bahasa Inggris" required>
                </div>
                <div class="form-group">
                    <label for="">Waktu Mengerjakan</label>
                    <input type="number" name="waktu" id="waktu_ubah" class="form-control" placeholder="ex: 60 *Satuan Menit" required>
                </div>
