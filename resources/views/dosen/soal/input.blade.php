        ...
        <div class="modal-body">
            ...
            @csrf
                <div class="form-group">
                    ...
                    <textarea id="soal" name="soal" class="form-control" rows="3" placeholder="ex: Ibukota Indonesia ?" style="margin-top: 0px; margin-bottom: 0px; height: 100px;" required></textarea>
                    <input type="hidden" name="id_paket_soal" id="id_paket_soal" value="{{ $data_paket->id_paket_soal }}">
                </div>
                <div class="form-group">
                    <label for="">Pilihan A</label>
                    <textarea id="pil_a" name="pil_a" class="form-control" rows="3" placeholder="ex: Jakarta." style="margin-top: 0px; margin-bottom: 0px; height: 50px;" required></textarea>
                </div>
                <div class="form-group">
                    <label for="">Pilihan B</label>
                    <textarea id="pil_b" name="pil_b" class="form-control" rows="3" placeholder="ex: Jakarta." style="margin-top: 0px; margin-bottom: 0px; height: 50px;" required></textarea>
                </div>
                <div class="form-group">
                    <label for="">Pilihan C</label>
                    <textarea id="pil_c" name="pil_c" class="form-control" rows="3" placeholder="ex: Jakarta." style="margin-top: 0px; margin-bottom: 0px; height: 50px;" required></textarea>
                </div>
                <div class="form-group">
                    <label for="">Pilihan D</label>
                    <textarea id="pil_d" name="pil_d" class="form-control" rows="3" placeholder="ex: Jakarta." style="margin-top: 0px; margin-bottom: 0px; height: 50px;" required></textarea>
                </div>
                <div class="form-group">
                    <label for="">Pilihan E</label>
                    <textarea id="pil_e" name="pil_e" class="form-control" rows="3" placeholder="ex: Jakarta." style="margin-top: 0px; margin-bottom: 0px; height: 50px;" required></textarea>
                </div>
                <div class="form-group">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            @csrf
                <div class="form-group">
                    <label for="">Soal</label>
                    <textarea id="soal_essay" name="soal_essay" class="form-control" rows="3" placeholder="ex: Ibukota Indonesia ?" style="margin-top: 0px; margin-bottom: 0px; height: 100px;" required></textarea>
                    <input type="hidden" name="id_paket_soal" id="id_paket_soal" value="{{ $data_paket->id_paket_soal }}">
                </div>
                <div class="form-row">
                    <div class="form-group col-md-7">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            @csrf
                <div class="form-group">
                    <label for="">Soal</label>
                    <textarea id="soal_ubah" name="soal" class="form-control" rows="3" placeholder="ex: Ibukota Indonesia ?" style="margin-top: 0px; margin-bottom: 0px; height: 50px;" required></textarea>
                    <input type="hidden" name="id_soal" id="id_soal" value="">
                </div>
                <div class="form-group">
                    <label for="">Pilihan A</label>
                    <textarea id="pil_a_ubah" name="pil_a" class="form-control" rows="3" placeholder="ex: Jakarta." style="margin-top: 0px; margin-bottom: 0px; height: 50px;" required></textarea>
                </div>
                <div class="form-group">
                    <label for="">Pilihan B</label>
                    <textarea id="pil_b_ubah" name="pil_b" class="form-control" rows="3" placeholder="ex: Jakarta." style="margin-top: 0px; margin-bottom: 0px; height: 50px;" required></textarea>
                </div>
                <div class="form-group">
                    <label for="">Pilihan C</label>
                    <textarea id="pil_c_ubah" name="pil_c" class="form-control" rows="3" placeholder="ex: Jakarta." style="margin-top: 0px; margin-bottom: 0px; height: 50px;" required></textarea>
                </div>
                <div class="form-group">
                    <label for="">Pilihan D</label>
                    <textarea id="pil_d_ubah" name="pil_d" class="form-control" rows="3" placeholder="ex: Jakarta." style="margin-top: 0px; margin-bottom: 0px; height: 50px;" required></textarea>
                </div>
                <div class="form-group">
                    <label for="">Pilihan E</label>
                    <textarea id="pil_e_ubah" name="pil_e" class="form-control" rows="3" placeholder="ex: Jakarta." style="margin-top: 0px; margin-bottom: 0px; height: 50px;" required></textarea>
                </div>
                <div class="form-group">
                    <label for="">Kunci Jawaban</label>
                    <br>
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            @csrf
                <div class="form-group">
                    <label for="">Soal</label>
                    <textarea id="soal_essay_ubah" name="soal_essay" class="form-control" rows="3" placeholder="ex: Ibukota Indonesia ?" style="margin-top: 0px; margin-bottom: 0px; height: 100px;" required></textarea>
