...
class LaporanController extends Controller
{
    ...
    public function get_data_mhs($id){
        ...
        return view('dosen.laporan.list-mhs', compact('list_mhs','nama_paket','id_paket'));         
    }
    ...
    public function cetak_nilai($id){
        ...
        $list_mhs = DB::table('tbl_paket_soal')
                    ...
                    $nama_kategori = DB::table('tbl_kategori_soal')
                    ...
                    $pdf = PDF::loadview('dosen.laporan.cetak_daftar_nilai',['list_mhs'=>$list_mhs,'nama_paket'=>$nama_paket,'nama_kategori'=>$nama_kategori]);
                    return $pdf->stream();
    ...
    public function get_data_jawaban_essay(Request $request){
        ...
        $data = DB::table('tbl_soal_essay')
                    ->join('tbl_jawab_essay','tbl_soal_essay.id_soal_essay','=','tbl_jawab_essay.id_soal_essay')
                    ->where([
                        ['tbl_jawab_essay.id_mhs', $request->id_mhs],
    ...
    public function get_file($path){
        ...
        //return PDF::loadFile(public_path('data_file').$path)->stream($path);
        return response()->file(public_path('data_file')."/".$path);
    }
}
