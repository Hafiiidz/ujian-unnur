...
class SoalController extends Controller
{
    ...
    public function simpan_soal(Request $request){
        ...
        if(!empty($request->gambar)){
            ...
            $gambar = Image::make($request->gambar)->resize(500, 500, function ($constraint) {
    ...
    public function simpan_soal_essay(Request $request){
        ...
        if(!empty($request->gambar_essay)){
            ...
            $gambar = Image::make($request->gambar_essay)->resize(500, 500, function ($constraint) {
                $constraint->aspectRatio();
                $constraint->upsize();
            })->encode('data-url');
